...
[1, 55,false,true] call BIS_fnc_cinemaBorder;
...
_role7 = "Avec les voix de:"; //In yellow
_role7names = ["Mr H. and Mrs H."]; //In white
 _role8 = "et:"; //In yellow
_role8names = ["Kmizole","Niakiniak"]; //In white
_role9 = "Guest star:"; //In yellow
_role9names = ["Padkoi","Dans le rôle du lieutenant"]; //In white
